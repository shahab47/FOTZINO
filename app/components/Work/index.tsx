...
const cardData: cardDataType[] = [
    {
        imgSrc: '/images/Features/1.png',
        heading: "Glow",
        subheading: "Glow your way to self-love",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/2.png',
        heading: "Glam",
        subheading: "Glam up your look with confidence ",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/3.png',
        heading: "Shine",
        subheading: "Shine your personality with confidence",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/4.png',
        heading: "Beauty",
        subheading: "Beauty is a journey, not a destination",
        link: 'Learn more'
    }
